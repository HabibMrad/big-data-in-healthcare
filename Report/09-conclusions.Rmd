# Conclusioni
Il modello addestrato con le covariate geniche ottiene un AUC superiore allo 0.9 che ne potrebbe indicare la bontà se non fosse che, ovviamente, abbiamo un grosso bias introdotto dalla di cicolarità (stesso dataset in training e test). \newline
