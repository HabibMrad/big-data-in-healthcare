...
Sull'asse delle x abbiamo la funzione di ripartizione del rischio predetto e la predictiveness curve ne rappresenta la funzione di ripartizione. Rispetto al modello perfetto, che arriva fino al 68.1% (complementare della probabilità 31.9%), la nostra predictivness curve ci mostra come (dopo il 10% circa) il modello sovrastimi il rischio di morte del paziente.
