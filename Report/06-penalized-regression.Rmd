...
La regressione penalizzata consiste nell'aggiungere un termine di penalizzazione che riduce i coefficienti della regressione fino a zero permettendo quindi di rimuovere la maggior parte delle variabili che non influiscono sull'accuratezza del modello.
$$ LPL(\beta|X, \lambda) =  LPL(\beta|X) - p_\lambda(\beta)$$

### Penalizzazione ridge

Nella penalizzazione ridge abbiamo
