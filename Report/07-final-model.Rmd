...
## Calibrazione e discriminazione del modello

### Calibrazione

Calcoliamo il rischio di morte al tempo t = 12 mesi, usando come modello il model2.
...
Rispetto al modello perfetto, che arriva fino al 68.1% (complementare della probabilità 31.9%), la nostra predictivness curve ci mostra come il modello sovrastimi eccessivamente il rischio di morte del paziente.
